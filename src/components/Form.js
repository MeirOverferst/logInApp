...
export default class Form extends Component {
  render() {
    return (
      <>
        <h2 className="title text-primary text-center my-4">Welcome to the starting Page</h2>
        <div className="container my-4">
          <div className="jumbotron">
            ...
            {this.props.formProps.hasFailed && <div className="alert alert-danger my-4">The username is Meir and the password is 5555. Please dont tell :P!</div>}
          </div>
        </div>
      </>
    )
